...
<jsp:useBean id="board1" class="dto.Board" scope="page"></jsp:useBean>
<jsp:useBean id="board2" class="dto.Board" scope="request"></jsp:useBean>
<jsp:useBean id="board3" class="dto.Board" scope="session"></jsp:useBean>
<jsp:useBean id="board4" class="dto.Board" scope="application"></jsp:useBean>
